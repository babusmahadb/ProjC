...
def snap_mirr(cluster: str, svm_name: str, volume_name: str, headers_inc: str):
    ...
    isp = scrp = desp = relid = dc_name = ds_name=ds_vuid=ds_vname=ds_vtype=ds_vpath=ds_vstate=ds_vsh_acl=ds_vsh_na=ds_vsh_no="NA"
    if snap_rd:
        for keys in snap_rd:
            relid = keys['uuid']
            src_val = keys['source']
    ...
    return isp,relid,scrp,dc_name,ds_name,desp,ds_vname,ds_vuid,ds_vstate,ds_vtype,ds_vpath,ds_vsh_no,ds_vsh_na,ds_vsh_acl
